/**
 * Copyright 2011-2025 Texas Torque.
 *
...
/**
 * A class representation of a PS4 controller, used for gathering
 * driver input.
 *
 * @author Tima Gezalov
 */
public final class TorquePS4Controller {
     ...
     */
    public TorquePS4Controller(final int port) { this(port, DEFAULT_DEADBAND); }
     ...
     */
    public TorquePS4Controller(final int port, final double deadband) {
     ...
     * @param port The controller port.
     */
    public TorquePS4Controller(final ControllerPort port) { this(port.ordinal()); }
     ...
     * @param deadband The deadband.
     */
    public TorquePS4Controller(final ControllerPort port, final double deadband) { this(port.ordinal(), deadband); }
     ...
     * @return The value of the left X axis.
     */
    public final double getRightXAxis() { return scale(axis(2)); }
     ...
     */
    public final double getLeftTriggerAxis() { return axis(3); }
     ...
     */
    public final double getRightTriggerAxis() { return axis(4); }
     ...
     * @return Is the left stick  currently down?
     */
    public final boolean isLeftStickClickDown() { return down(11); }
     ...
     * @return Is the right stick  currently down?
     */
    public final boolean isRightStickClickDown() { return down(12); }
     ...
     * @return Is the left center button currently down?
     */
    public final boolean isLeftCenterButtonDown() { return down(9); }
     ...
     * @return Is the right center button currently down?
     */
    public final boolean isRightCenterButtonDown() { return down(10); }
     ...
     * @return Is the X button currently down?
     */
    public final boolean isXButtonDown() { return down(2); }
     ...
     * @return Is the Y button currently down?
     */
    public final boolean isSquareButtonDown() { return down(1); }
     ...
     * @return Is the B button currently down?
     */
    public final boolean isOButtonDown() { return down(3); }
     ...
     * @return Is the A button currently down?
     */
    public final boolean isTriangleButtonDown() { return down(4); }
     ...
     */
    public final boolean isLeftStickClickPressed() { return pressed(11); }
     ...
     */
    public final boolean isRightStickClickPressed() { return pressed(12); }
     ...
     */
    public final boolean isLeftCenterButtonPressed() { return pressed(9); }
     ...
     */
    public final boolean isRightCenterButtonPressed() { return pressed(10); }
     ...
     */
    public final boolean isXButtonPressed() { return pressed(2); }
     ...
     */
    public final boolean isSquareButtonPressed() { return pressed(1); }
     ...
     */
    public final boolean isOButtonPressed() { return pressed(3); }
     ...
     */
    public final boolean isTriangleButtonPressed() { return pressed(4); }
     ...
     */
    public final boolean isLeftStickClickReleased() { return released(11); }
     ...
     */
    public final boolean isRightStickClickReleased() { return released(12); }
     ...
     */
    public final boolean isLeftCenterButtonReleased() { return released(9); }
     ...
     */
    public final boolean isRightCenterButtonReleased() { return released(10); }
     ...
     */
    public final boolean isXButtonReleased() { return released(2); }
     ...
     */
    public final boolean isSquareButtonReleased() { return released(1); }
     ...
     */
    public final boolean isOButtonReleased() { return released(3); }
     ...
     */
    public final boolean isTriangleButtonReleased() { return released(4); }
