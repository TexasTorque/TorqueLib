 ...
 * For more details, see ./license.txt or write <mkattangere@gmail.com>.
 */
...
/**
 *  Torque Polynomial Regression: Simple polynomial regression on data points given
 * 
 *  @author Maaz Kattangere
 */
public class TorquePolynomialRegression implements Comparable<TorquePolynomialRegression> {
  ...
  /**
     ...
     */
    public TorquePolynomialRegression(double[] x, double[] y, int degree) {
        this(x, y, degree, "n");
    }
  ...
  /**
     ...
     * @throws IllegalArgumentException if the lengths of the two arrays are not equal
     */
    public TorquePolynomialRegression(double[] x, double[] y, int degree, String variableName) {
        this.degree = degree;
   ...
   /**
     ...
     */
    public int compareTo(TorquePolynomialRegression that) {
        double EPSILON = 1E-5;
