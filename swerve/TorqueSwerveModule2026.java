 ...
 * Updated to work with WCP Swerve X2i modules for 2026.
 * 
 ...
 */
public final class TorqueSwerveModule2026 extends TorqueSwerveModule {
    ...
    public TorqueSwerveModule2026(final String name, final SwervePorts ports) {
        super(name);
        ...
        /* Gear Ratio Config */
        driveConfig.Feedback.SensorToMechanismRatio = 6.39;
    ...
    public void setDesiredState(final SwerveModuleState state) {
        turnPID.setP(SmartDashboard.getNumber("(Swerve) Turn P", 0.375));
