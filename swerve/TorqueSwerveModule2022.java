 ...
 *
 * The module uses a Rev NEO for drive and rotation control. It uses a CTRE Cancoder positioned 1:1
...
public final class TorqueSwerveModule2022 extends TorqueSwerveModule {
     ...
     *
     * Has default values that can be overriden before written to the module.
     */
    public static final class SwerveConfig {
        ...
        public double voltageCompensation = 12.6, // volts
                ...
                driveStaticGain = 0.015, driveFeedForward = 0.212, drivePGain = 0.2,
                driveIGain = 0.0, driveDGain = 0.0,
                ...
                turnPGain = 0.3, turnIGain = 0.0, turnDGain = 0.0, turnGearRatio = 12.41; // Rotation
                                                                                          // motor
                                                                                          // to
                                                                                          // wheel
    }
    ...
    public TorqueSwerveModule2022(final String name, final int driveID, final int turnID,
            final int encoderID, final double staticOffset, final SwerveConfig config,
