...
public class TorqueCounter extends Counter {
     ...
     *
     * @param port Which port the counter is on.
     */
     ...
     *
     * @param source The digital input source.
     */
     ...
     *
     * @param upPort Port connected to the up counter.
     * @param downPort Port connected to the down counter.
     * @param reverse Whether or not the counter is reversed.
     * @param encodingype What type encoding the counter is using.
     */
     ...
     *
     * @param trigger The analog trigger.
     */
