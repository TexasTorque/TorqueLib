...
public final class TorqueMiscUtils {
    ...
    */
    ...
    public enum PrintColor {
        ...
        public final void makeBold() { this.isBold = true; }
     ...
     */
    public static final void print(final PrintColor color, final String message) { printfximpl(color, "%s", message); }
    ...
    public static final void print(final PrintColor color, final Object... arguments) {
        ...
        for (final Object argument : arguments) builder.append(argument);
    ...
    private static final void printfximpl(final PrintColor color, final String format, final Object... arguments) {
        ...
        System.out.printf(String.format("%s.%s -> ", parent.getClassName(), parent.getMethodName()) + color.getCode() +
                                  format + PrintColor.RESET.getCode(),
                          arguments);
    }
