...
public final class TorqueGearBox {
     ...
     */
    public TorqueGearBox(final double ratio) { this.ratio = ratio; }
     ...
     * @param input The size of the input gear.
     */
    public TorqueGearBox(final double output, final double input) { ratio = output / input; }
     ...
     */
    public final double getRatio() { return ratio; }
     ...
     */
    public final double mechanismToMotor(final double input) { return input * ratio; }
     ...
     */
    public final double motorToMechanism(final double input) { return input / ratio; }
}
